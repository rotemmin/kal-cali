...
//       const updatedTopic = topic.replace(/-/g, "_"); // Replace hyphens with underscores

//       // Ensure the topic exists
//       if (!(updatedTopic in topicsAndMilestones)) {
//         alert("Topic not found in user's activity data");
//         return;
//       }

//       // Decrease the number of remaining milestones for the current topic
//       if (topicsAndMilestones[updatedTopic] > 0) {
//         topicsAndMilestones[updatedTopic] -= 1;
//       } else {
//         alert("Milestone already completed for this topic");
//         return;
//       }
...
//       if (topicsAndMilestones[updatedTopic] === 0) {
//         updatedBudget += 1; // Increment budget when a topic is completed
//       }
